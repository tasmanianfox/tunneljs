...
- **If you have installation or compilation issues with this project, please see [electron-react-boilerplate debugging guide](https://github.com/chentsulin/electron-react-boilerplate/issues/400)**

First, clone the repo via git:

```bash
git clone git@github.com:tasmanianfox/tunneljs.git your-project-name
```
...
GNU GPL 3.0 © [S. Belyakov](https://github.com/tasmanianfox)
